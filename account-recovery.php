...
<head>
    ...
    <title>Axion - Account Recovery</title>
...
<body class="d-flex flex-column min-vh-100 container">
    ...
    <main class="flex-grow-1 d-flex flex-column">
        ...
        <form method="POST" action="./account-recovery.php" class="row g-3">
            <?php
            ...
            <div class="col-12">
                <button type="submit" name="reset_password" class="btn btn-lg btn-success rounded-4 w-auto">
                    Reset Password
                </button>
            </div>
        </form>
